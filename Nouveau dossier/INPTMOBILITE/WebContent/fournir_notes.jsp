...
<input type="hidden" name="page" value="note"   >
    ...
    <p>
        <label id="notes">Fichier des notes  * : </label>
        <input id="notes" name="notes"   type="file"  required  /><span style="color:#900;"> Format( (extention .xls )  | max. 100 Mo)   </span>  
